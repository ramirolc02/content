...
- **Buy Index Funds (Fondos Indexados):** A recently attractive option, especially for Spanish investors, is using platforms like MyInvestor to buy index funds such as the *iShares US Equity Index Fund (clase S)*. This approach offers a significant tax advantage: in Spain, investment funds allow you to transfer your capital between different funds without triggering capital gains taxes ("traspasos sin tributar", amparándose en el régimen de diferimiento fiscal del artículo 94 de la Ley del IRPF). This means you can rebalance or move your money without a tax hit until you actually withdraw it.

CFDs and ETFs generally have 15% taxes on US dividends (if you are based in Spain). Total expense Ratios tend to be lower with CFDs, but i would rather own the underlying asset.
